        ...
        >
          ...
          <div style={{border: '1px solid #3d84b8', padding: '15px'}}>
            <h3 style={{textAlign: 'left'}}>TourViewAR</h3>
              ...
              <h5 style={{fontWeight: '400', display: 'inline-block', textAlign: 'center', padding: '0px 0px'}}><a style={{textAlign: 'center'}} href="https://arobjectimages.s3-us-west-1.amazonaws.com/portfolio/AustinLiuTourViewAR.ipa" className="download icon fa-apple fa-2x"></a><div style={{display: 'block'}}>IOS (.ipa)</div></h5>
              <h5 style={{fontWeight: '400', display: 'inline-block', textAlign: 'center', padding: '0px 0px'}}><a style={{textAlign: 'center'}} href="https://arobjectimages.s3-us-west-1.amazonaws.com/portfolio/AustinLiuTourViewAR.apk" className="download icon fa-android fa-2x"></a><div style={{display: 'block'}}>Android (.apk)</div></h5>
